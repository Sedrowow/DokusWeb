...
var characterList = ['Dokus', 'Core', 'Best', 'QualityOverQuantity', 'Quality', 'NoQuantity','DokusCore', 'BestFramework'];
...
var layers = {
    ...
    size: [10, 16, 26, 34, 40], //font size of the letters (starting from the deepest layer)
    color: ['#fff', '#eee', '#ccc', '#bbb', '#aaa'], //color of the letters (starting from the deepest layer)
    font: 'Roboto' //font family (of every layer)
};
